          ...
          {teamMembers.map((member) => (
            ...
            >
              ...
              <div className="p-5 text-center mt-auto">
                ...
                <p className="text-gray-600 text-sm leading-relaxed line-clamp-2 mb-3">{member.bio}</p>
                <a 
                  href="#" 
                  className="inline-flex items-center justify-center w-full py-2 px-4 text-sm font-medium text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-lg transition-colors"
