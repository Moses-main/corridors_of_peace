        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-6">
              Corridors of Peace is a non-profit organization dedicated to preserving the dignity of women and girls in Chad. 
              We work towards creating sustainable change through education, economic empowerment, and social protection programs.
            </p>
            <p className="text-gray-600 mb-6">
              Our mission is to empower women and girls in Guereda by providing them with the tools, resources, and support they need 
              to build better futures for themselves and their communities.
            </p>
            <div className="bg-blue-50 p-6 rounded-lg">
              <h4 className="font-semibold text-lg text-blue-800 mb-2">Our Vision</h4>
              <p className="text-gray-700">
                A world where every woman and girl in Chad has the opportunity to live with dignity, free from poverty and discrimination.
              </p>
            </div>
          </div>
