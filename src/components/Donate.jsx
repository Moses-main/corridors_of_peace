...
const Donate = () => {
  ...
  return (
    <section id="donate" className="py-16 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
          <div className="mb-12 lg:mb-0">
            <h2 className="text-3xl font-bold mb-6">Make a Difference Today</h2>
            <p className="text-blue-100 mb-6 text-lg">
              Your generous donation will help us continue our mission to empower women and girls in Chad. 
                  ...
                  <div className="mb-6">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="flex items-center justify-between mb-3">
                        <span className="text-gray-700 font-medium">Donation Type</span>
