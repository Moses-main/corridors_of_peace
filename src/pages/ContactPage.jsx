      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="md:w-1/2 p-8 md:p-12 bg-blue-600 text-white">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-blue-100">1234 Peace Avenue<br />N'Djamena, Chad</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="mailto:info@corridorsofpeace.org" className="text-blue-100 hover:underline">info@corridorsofpeace.org</a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="tel:+235123456789" className="text-blue-100 hover:underline">+235 12 34 56 78</a>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-white">
                  ...
                  <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-white">
                  ...
                  <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-white">
        ...
        <div className="mt-16 bg-white rounded-lg shadow-md overflow-hidden">
          <div className="h-64 w-full bg-gray-200">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15737.03348341358!2d15.052891!3d12.1348457!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTLCsDA4JzA1LjQiTiAxNcKwMDMnMTAuNCJF!5e0!3m2!1sen!2sus!4v1620000000000!5m2!1sen!2sus"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
